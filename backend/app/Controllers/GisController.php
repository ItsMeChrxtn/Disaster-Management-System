...
final class GisController
{
    ...
    public function coveredLocations(Request $r): never
    {
        ...
        $municipalityIds=[];foreach([...$coveredMunicipalities,...$coveredSafeZones,...$coveredCenters] as $row){$id=(int)($row['municipality_id']??$row['id']);$municipalityIds[$id]=true;}
