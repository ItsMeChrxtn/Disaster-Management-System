...
final class EvacuationCenterController
{
    ...
    private function validated(Request $r): array
    {
        ...
        return ['center_name'=>$name,'municipality_id'=>$mid,'address'=>$address,'contact_person'=>$contactPerson?:null,'contact_number'=>$contact?:null,'capacity'=>(int)$capacity,'status'=>$d['status'],'latitude'=>(float)$lat,'longitude'=>(float)$lng];
    }
